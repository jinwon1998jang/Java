...
public class Car {
	...
	//속성(멤버변수, 필드) - 무조건 private 으로 선언, 상속관계에서 부모 클래스이면 protected 로 선언
	private String name;
	private String color;
	protected int speed; 
	//상속 관계에서 자식 클래스에서 참조 가능하게 접근 권한을 protected 로 변경
	
	
	
	/*생성자(Constructor) - 속성을 초기화하는 반환타입이 없고
	클래스 이름이 그대로  메서드 이름으로 사용
	*/
