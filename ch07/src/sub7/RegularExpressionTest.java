...
public class RegularExpressionTest {
	...
	public static void main(String[] args) {
		...
		boolean res1 =Pattern.matches(pattern, "apple");
		boolean res2 =Pattern.matches(pattern, "banana");
		...
		String[] patterns = {
								...
								"^[0-9]",  	// 숫자로 시작하는 문자 //^[]밖 시작, []밖 $ 끝, ^[] 안 not 
								"[^0-9]",  	// 숫자가 아닌 문자
								".",	   	// 문자 1개
								"[a-z]?",	// 영어 소문자 1개
								"[a-z]*",	// 영어 소문자 0개 이상
		...
		for (String word : words) {
			System.out.println(word+"문자와 일칯하는 패턴: ");
